...
class WatchApps extends Component {
    ...
    render() {
        return ( <
            ...
            <
            a href = "//"
            className = 'go-link' > < FaGithub className = 'view-icon' / > < /a> <
            a href = "//"
            className = 'go-link' > < FaChrome className = 'view-icon' / > < /a>  <
            a href = "//"
            className = 'go-link' > < MdOutlineDescription className = 'view-icon' / > < /a>  <
            /div> <
